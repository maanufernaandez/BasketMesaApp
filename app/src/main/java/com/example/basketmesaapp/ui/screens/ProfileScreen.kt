...
fun ProfileScreen(onBack: () -> Unit, onLogout: () -> Unit) {
    ...
    Scaffold(
        ...
        // BoxWithConstraints nos permite saber cuánto mide la pantalla de alto
        BoxWithConstraints(
            modifier = Modifier
                .fillMaxSize()
                .padding(padding)
            ...
            // Restamos 32.dp (el padding de 16.dp de arriba + 16.dp de abajo)
            val minColumnHeight = this.maxHeight - 32.dp
            ...
            Column(
                ...
                // Columna interna que se estirará como mínimo al tamaño de la pantalla
                Column(
                    modifier = Modifier
                        .fillMaxWidth()
                        .heightIn(min = minColumnHeight),
                    // SpaceBetween empuja el contenido hacia los extremos
                    ...
                    Column(
                        ...
                        Text("Datos Personales", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = MaterialTheme.colorScheme.onSurface)
                    ...
                    Column(
                        ...
                        Text("Cambiar Contraseña", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = MaterialTheme.colorScheme.onSurface)
                        ...
                        OutlinedTextField(
                            ...
                            supportingText = if (passwordError) { { Text("Mínimo 8 caracteres, 1 mayús, 1 minús y 1 número.", color = Color.Red) } } else null,
